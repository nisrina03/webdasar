...
<div class="col-lg-10 col-xxl-4 my-5 mx-auto">
    ...
    ?>
        <div class="alert alert-success" role="alert">
            <i class=bi bi-info-circlr"></i> Data Berhasil ditambah <a href="btn btn-link">Halaman Utama</a>
        </div>
    <?php
    }
    ...
    <form class="row needs-validation" action="tambah.php" method="post">
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" id="validationCustom04" name="tgl_lahir" required>
            <div class="valid-feedback">
            Looks good!
            </div>
        </div>
        ...
        <div class="mt-3">
            <button class="btn btn-primary btn-large" type="submit" name="tambah">Tambah</button>
        </div>  
